...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <a href="#" class="brand-link">
        <span class="brand-text font-weight-light">Admin Phone</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{url('/img/pp.jpg')}}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
...
{{--Font Awesome--}}
<script src="https://kit.fontawesome.com/8589aeb585.js" crossorigin="anonymous"></script>
</html>
